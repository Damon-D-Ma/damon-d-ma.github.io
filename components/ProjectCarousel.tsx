        ...
        <div className="overflow-hidden h-200 bg-zinc-800 w-5/6 rounded-lg" ref={emblaRef}>
                <div className="flex">
                    <div className="flex-none w-full px-5 py-5 mx-auto">
                        <div className='flex'>
                            <img src='grammar-game-screenshot.png' alt='Fix my Mistakes photo' className='hidden md:block w-3/5 max-h-[600px] rounded-lg'/>
                            <div className=' text-left px-5'>
                                ...
                                <div className='pt-12 flex flex-wrap'>
                                    <TechItem icon={<img  src='./javascript.svg' alt='' className='h-4 w-4 object-fit rounded-full'/>} text='JavaScript'/>
                                    <TechItem icon={<img  src='./file-type-html.svg' alt='' className='h-4 w-4 object-fit rounded-full'/>} text='HTML'/>
                                    <TechItem icon={<img  src='./file-type-css.svg' alt='' className='h-4 w-4 object-fit rounded-full'/>} text='CSS'/>
                                    <TechItem icon={<img  src='./react-js-icon.png' alt='' className='h-4 w-4 object-fit rounded-full'/>} text='React.js'/>
                                    <TechItem icon={<img  src='./file-type-firebase.svg' alt='' className='h-4 w-4 object-fit rounded-full'/>} text='Firebase'/>
                                    <TechItem icon={<div className='bg-white rounded-full'><img  src='./github-mark.svg' alt='' className='h-4 w-4 object-fit rounded-full'/></div>} text='GitHub'/>
                                </div>
                        ...
                        <div className='flex'>
                            ...
                            <div className='text-left px-5'>
                                ...
                                <div className='pt-12 flex flex-wrap'>
                                    ...
                                    <TechItem icon={<img  src='./file-type-html.svg' alt='' className='h-4 w-4 object-fit rounded-full'/>} text='HTML'/>
                                    <TechItem icon={<img  src='./file-type-tailwind.svg' alt='' className='h-4 w-4 object-fit rounded-full'/>} text='Tailwind CSS'/>
                                    <TechItem icon={<img  src='./react-js-icon.png' alt='' className='h-4 w-4 object-fit rounded-full'/>} text='React.js'/>
                                    <TechItem icon={<div className='bg-white rounded-full'><img  src='./next-js.svg' alt='' className='h-4 w-4 object-fit rounded-full'/></div>} text='Next.js'/>
                                    <TechItem icon={<div className='bg-white rounded-full'><img  src='./github-mark.svg' alt='' className='h-4 w-4 object-fit rounded-full'/></div>} text='GitHub'/>
                                    <TechItem icon={<img  src='./github-pages.png' alt='' className='h-4 w-4 object-fit rounded-full'/>} text='GitHub Pages'/>
                        ...
                        <div className='flex'>
                            ...
                            <div className='wtext-left px-5'>
                                ...
                                <div className='pt-12 flex flex-wrap'>
                                    <TechItem icon={<div className='bg-white rounded-full'><img  src='./file-type-java.svg' alt='' className='h-4 w-4 object-fit rounded-full'/></div>} text='Java'/>
                                    <TechItem icon={<div className='bg-white rounded-full'><img  src='./JavaFX.png' alt='' className='h-4 w-4 object-fit rounded-full'/></div>} text='JavaFX'/>
                                    <TechItem icon={<img  src='./Git-Icon-White.png' alt='' className='h-4 w-4 object-fit rounded-full'/>} text='Git'/>
                    ...
                    <div className="flex-none w-full px-5 py-5  mx-auto">
                        <div className='flex'>
                            <img src='duber-paint-screenshot.png' alt='Duber Paint photo' className='hidden md:block w-3/5 h-[600px] rounded-lg'/>
                            <div className='wtext-left px-5'>
                                ...
                                <div className='pt-12 flex flex-wrap'>
                                    <TechItem icon={<div className='bg-white rounded-full'><img  src='./file-type-python.svg' alt='' className='h-4 w-4 object-fit rounded-full'/></div>} text='Python'/>
                                    <TechItem icon={<div className='bg-white rounded-full'><img  src='./pygame.png' alt='' className='h-4 w-4 object-fit rounded-full'/></div>} text='PyGame'/>
                                    <TechItem icon={<div className='bg-white rounded-full'><img  src='./github-mark.svg' alt='' className='h-4 w-4 object-fit rounded-full'/></div>} text='GitHub'/>
                                </div>
                                <div className='pt-4 flex flex-col'>
                                    <div className='hover:bg-[#1e43a1] transition duration-500'>
                    ...
                    <div className="flex-none w-full px-5 py-5  mx-auto">
                        <div className='flex'>
                            <img src='tuesday-screenshot.png' alt='Tuesday photo' className='hidden md:block w-3/5 h-[600px] rounded-lg'/>
                            <div className='wtext-left px-5'>
